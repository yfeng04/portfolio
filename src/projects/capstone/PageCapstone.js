            ...
            <div className="content-wrapper">
                <main className="single-project"> 
                    ...
                    <section className="content intro-section">
                        <h1>Farm to Plate</h1>
                        <p className="overview">Farm to Plate is a fictitious business that sells weekly food subscription boxes. In a team of 4, we built a multi-page e-commerce website with WordPress and WooCommerce. This site features a fully custom theme which includes custom post types, custom fields, taxonomies, and styles.</p>
                    </section>
                    
                    <section className="content external-links">
                        <a target="_blank" rel="noreferrer" href="https://yingyingfeng.com/farm-to-plate">Live Site</a>
